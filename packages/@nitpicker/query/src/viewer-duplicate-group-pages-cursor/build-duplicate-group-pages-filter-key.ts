import type { DuplicateGroupPagesCursorFilterKeyInput } from './types.js';
 ...
 */
export function buildDuplicateGroupPagesFilterKey(
	filters: DuplicateGroupPagesCursorFilterKeyInput,
): string {
	return buildFilterKey({ groupId: filters.groupId });
}
