import type { DuplicateGroupsKeysetRow, DuplicateGroupsSortSpec } from './types.js';
 ...
 */
export function extractDuplicateGroupsSortValues(
	spec: DuplicateGroupsSortSpec,
	row: DuplicateGroupsKeysetRow,
): (string | number)[] {
