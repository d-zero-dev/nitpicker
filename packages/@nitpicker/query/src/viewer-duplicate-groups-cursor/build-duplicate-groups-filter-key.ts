import type { DuplicateGroupsCursorFilterKeyInput } from './types.js';
 ...
 */
export function buildDuplicateGroupsFilterKey(
	filters: DuplicateGroupsCursorFilterKeyInput,
): string {
	return buildFilterKey({ field: filters.field });
}
