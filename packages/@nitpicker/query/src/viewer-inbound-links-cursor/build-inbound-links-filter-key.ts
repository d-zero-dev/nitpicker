import type { InboundLinksCursorFilterKeyInput } from './types.js';
 ...
 */
export function buildInboundLinksFilterKey(
	filters: InboundLinksCursorFilterKeyInput,
): string {
	return buildFilterKey({ destPageId: filters.destPageId });
}
