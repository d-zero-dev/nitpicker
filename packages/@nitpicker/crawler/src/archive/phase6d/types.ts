/**
 * Domain types for the Phase 6-D entity/edge population step (issue #193).
 *
 * The Phase 6-D populate helpers translate rows from the legacy write
 ...
 * that Phase 6-C created. Every ref-id lookup goes through a small set of
 ...
 * not happen after Phase 6-B-0 populates every distinct value).
 */
 ...
 * {@link ../phase6b/compute-content-hash.ts} for the algorithm choice).
 */
