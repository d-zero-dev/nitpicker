...
import { decodeDataUri } from '../phase6b/decode-data-uri.js';
 ...
 * (issue #193).
 *
 * The routing rule matches {@link ../phase6b/populate-blob-refs.ts}:
 ...
 * before hashing.
 *
 * Malformed data URIs that fail {@link ../phase6b/decode-data-uri.ts}
