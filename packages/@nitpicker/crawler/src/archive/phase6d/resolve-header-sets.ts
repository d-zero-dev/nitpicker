...
import { computeContentHash } from '../phase6b/compute-content-hash.js';
import { decomposeHeaderSet } from '../phase6b/decompose-header-set.js';
 ...
 *    {@link ../phase6b/populate-header-tables.ts}).
 ...
 * SHA-256 (see {@link ../phase6b/compute-content-hash.ts} for the
 * algorithm choice). The `raw_hash` fallback re-decomposes each miss via
 * {@link ../phase6b/decompose-header-set.ts} so the canonicalisation
 * matches the one Phase 6-B-5 used at insert time.
 *
