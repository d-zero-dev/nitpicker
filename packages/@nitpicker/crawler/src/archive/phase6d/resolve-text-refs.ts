 ...
 * {@link ../phase6b/compute-content-hash.ts} (32-byte SHA-256, matching
 * how `populateTextRefs` inserted the rows in Phase 6-B-2) before the
 ...
 *   Phase 6-B-2 completes but does happen mid-migration when a caller
