 ...
 * `dom_path` strings, which are synthesised during Phase 6-D-6 and were
 * not among the Phase 6-B-2 sources — the caller cannot rely on the
 ...
 * {@link ../phase6b/populate-header-tables.ts}'s `resolveValueIds`) so
