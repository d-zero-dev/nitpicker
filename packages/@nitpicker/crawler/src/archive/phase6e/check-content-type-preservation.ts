...
/**
 * Verifies Phase 6-E invariant #7: no page loses its content-type across the
 * Phase 6-D-1 populate.
 *
 ...
 * @throws {Phase6VerificationError} when any content-type is silently dropped.
 */
