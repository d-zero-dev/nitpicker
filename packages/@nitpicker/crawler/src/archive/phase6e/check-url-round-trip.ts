 ...
 * and `docs/write-model-refactor-plan.md` §Phase 6-E as a 1,000-row sample.
...
/**
 * Verifies Phase 6-E invariant #8: `content_items.url_id → url_refs.url`
 ...
 * @throws {Phase6VerificationError} when at least one sampled URL does not round-trip.
 */
