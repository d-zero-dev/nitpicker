/**
 * Data payload sent inside a `task` message from {@link ./worker-pool.ts!WorkerPool} to a worker.
 *
 ...
 * @see {@link ./worker-pool.ts!WorkerPool.run} for where this payload is constructed
